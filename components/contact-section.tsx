import { Github, Linkedin, Mail, MessageCircle, Twitter, Video } from "lucide-react"
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-10 flex flex-col items-center gap-6 sm:flex-row sm:justify-center">
            <a
              ...
              className="flex items-center gap-3 rounded-xl border border-border/50 bg-card/50 px-6 py-4 backdrop-blur-sm transition-colors hover:border-primary/30 hover:bg-card"
            >
          ...
          <div className="mt-8 flex items-center justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-lg border border-border/50 bg-card/50 p-3 text-muted-foreground transition-colors hover:border-primary/30 hover:text-primary"
              aria-label="GitHub"
            >
